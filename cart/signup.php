...
<head>
    ...
    <link rel="stylesheet" href="../users acount/style.css">
...
<body>
    <div class="container">
        ...
        <form method="post" name="Register" id="reg">
            ...
            <input type="text" id="phone-number" name="phone-number" placeholder="يجب أن يكون رقم الهاتف أقل من 15 رقم" minlength="9" maxlength="14" pattern="[0-9+]{9,14}" title="يرجى إدخال رقم هاتف صحيح (من 9 إلى 14 رقمًا)">
            <label for="password">كلمة السر:</label>   
            <div class="password_and_eyes_icon">
            <input type="password" id="password" name="password" minlength="7" title="يرجى إدخال كلمة مرور قوية بحيث لا تقل عن 7 حروف او ارقام او رموز)">
...
@$type_user = 1; // نوع المستخدم (1 = أدمن)
...
if (isset($button_add)) {
    ...
    try {//مسك الخطاء اذا كان هناك تكرار في البيانات
        ...
        if ($result) {
            ...
            echo '<script>alert("تم إنشاء حساب  بنجاح"); window.location.href = "order_addres.php";</script>';
            exit(); // خروج
        } else {
