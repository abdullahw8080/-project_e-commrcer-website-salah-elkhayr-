...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $section = ($_POST['Pr_section']); // اسناد قسم المنتج إلى المتغير
    ...
    if (isset($add_product)) {
        try {
            ...
            $product_query = "INSERT INTO products (P_name, P_old_price, P_new_price, Discount, p_unit_id, p_description, p_weight, Section_id)
                              VALUES ('$product_name', '$old_price', '$new_price', '$discount', '$unit', '$product_descrption', '$product_weight', '$section')";
